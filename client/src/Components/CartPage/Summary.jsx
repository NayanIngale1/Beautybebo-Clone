    ...
    return (
        <div id="summary">
            <div id="top">
                ...
                <div id="ESTIMATE_SHIPPING" onClick={handleEstimate}>ESTIMATE SHIPPING AND TAX {estimate ? <IoIosArrowUp /> : <IoIosArrowDown />}</div>
                {estimate ?
                    <>
                        <div id="enter_destination">Enter your destination to get a shipping estimate.</div>
                        ...
                        <select name="state" id="state">
                            <option value="default">Please select a region,state or province</option>
                ...
                <div>
                    ...
                    <div id="shipping_div">
                        <div id="shipping"><span style={{ fontWeight: "600" }}>Shipping</span> (Best Way - Max 7 Business days)</div>
                    ...
                    <div id="apply_discount" onClick={handleCoupon}>APPLY DISCOUNT CODE {coupon ? <IoIosArrowUp /> : <IoIosArrowDown />}</div>
                    {coupon ? <>
                        <div id="Enter_discount">Enter discount code</div>
                        <input type="text" placeholder="Enter discount code" id="Enter_discount_inpt"/>
